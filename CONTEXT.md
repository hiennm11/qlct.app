...
- ~~Only 1 test file (`widget_test.dart`). Zero unit/integration tests for VM, repo, services.~~ ✅ Fixed — 353 tests total: model tests, datasource tests, repository tests, ViewModel tests, service tests, widget tests, integration tests.
